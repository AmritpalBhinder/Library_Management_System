...
//   useEffect(() => {
//     if (singleBook) {
//       setTitle(singleBook.title || singleBook.Title || "");
//       setAuthor(singleBook.author || "");
//       setGenre(singleBook.genre || "");
//       setRent(singleBook.rent || "");
//       setQuantity(singleBook.quantity || "");
//       setIsbns(
//         singleBook.isbns
//           ? singleBook.isbns.join(",")
//           : singleBook.isbn
//           ? singleBook.isbn.join(",")
//           : ""
//       );
//       setAvailability(
//         singleBook.availability ||
//           (singleBook.isAvailable ? "available" : "unavailable")
//       );
//       setRating(singleBook.rating || "");
//       setImageUrl(singleBook.image_url || singleBook.cover || "");
//     }
//   }, [singleBook]);
...
//     const updatedBook = {
//       title, // ✅ always save as lowercase "title"
//       author,
//       genre,
//       rent: rent ? parseFloat(rent) : 0,
//       quantity: quantity ? parseInt(quantity) : 0,
//       isbns: isbns ? isbns.split(",").map((isbn) => isbn.trim()) : [],
//       availability, // "available" or "unavailable"
//       isAvailable: availability === "available", // ✅ keep both for safety
//       rating: rating ? parseFloat(rating) : 0,
//       image_url: imageUrl,
//       cover: imageUrl, // ✅ match your db.json structure
//     };
