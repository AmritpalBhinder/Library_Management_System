...
export default function Members() {
  ...
  const filteredMembers = members.filter((member) => {
    ...
    const matchesStatus =
      filterStatus === "" ||
      (filterStatus === "Active" && member.activeStatus === true) ||
      (filterStatus === "Inactive" && member.activeStatus === false);
  ...
  return (
    <div
      className="container mt-4 members-page"
      style={{ width: "90%", marginLeft: "6%", backgroundColor: "white" }}
    >
      <h1 className="mb-4 fw-bold">Members</h1>

      {/* Search + Filters */}
      <div className="d-flex mb-3 gap-4 flex-wrap align-items-center search-filters">
        <input
          type="text"
          ...
          >
            ...
            >
              <div className="ms-2 me-auto d-flex align-items-center">
                <img
                  src={member.profileImage?.trim() || "/default-avatar.png"}
                  alt={member.name}
                ...
                <div className="member-details-inline">
                  ...
                  <div className="member-info-line mt-3 text-start px-3">
                    ...
                    <p>
                      ...
                      >
                        {selectedMember.activeStatus ? "Active" : "Inactive"}
                      </span>
                    </p>
                  </div>
                </div>
